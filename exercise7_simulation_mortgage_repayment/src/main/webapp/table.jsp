...
<c:choose>
    <c:when test="${repayment.size()>0}">
        ...
        <div id="header">Harmonogram spłat RRSO wynosi ${rrso} %</div>
        <br/>
        <div >Całkowita kwota do spłaty: ${theTotalAmountToBeRepaid} zł</div>
        <br/>
        <table id="myTable" class="table table-fixedheader table-dark">
            ...
            <c:forEach var="row" items="${repayment}" varStatus="index">
                ...
                <tr>
                    ...
                    <td width="20%"><c:out value=""/>${repayment.size()*installment - index.count*installment} zł</td>
